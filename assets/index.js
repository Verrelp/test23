...
const novel_1 = new NovelBook("Rindu", "Tere Liye", "2009"); LIST_OF_BOOK.push(novel_1.getBook());
...
const biografi_1 = new BiografiBook("Al Wafa | Siroh Nabawi", "Imam Ibnul Qoyim", "1190"); biografi_1.setCategory("Sejarah");
LIST_OF_BOOK.push(biografi_1.getBook());

const biografi_2 = new BiografiBook("Tarikh Khulafa", "Salaluddin as-Suyuthi", "1990"); biografi_2.setCategory("Sejarah");
